package com.sdettrainingSele.day2;
//import  FMHerndonSMU.com.FMHerndonSMU.Tests.Log;
...
public class C_17_4e_TestNG_DataProvider extends ExtReports 
{
	...
	public Object[][] testdata_shoppingCart() {
		return new Object[][] { 
				...
				new Object[] { "Echo", "5", "David", "BOSTON", "MA" } 
			    };
	}
	...
	public void tc_shoppingCartTesting(String item2Search, String qty, String customerName, String customerCity,
			String customerState) throws InterruptedException, IOException {
		...
		extentReport = new ExtentReports("C:\\SeleniumJar\\Reports\\ExtentReport.html");
	...
	//	driver = new ChromeDriver();
		...
		FileUtils.copyFile(screenshot,
				new File("C:\\SeleniumJar\\screenshot\\" + customerName + "screenshot.jpg"));
*/
		
		ReUsableFunctions.GetSceenshot("C:\\SeleniumJar\\screenshot\\", customerName + "screenshot.jpg");
		driver.findElement(By.xpath("(//input[@name='cmdSubmit'])[3]")).click();
