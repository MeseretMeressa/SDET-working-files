...
import com.sdettrainingSele.day2.ReUsableFunctions;
...
public class DDT_CSV {
	...
	public void tc_shoppingCartTesting() throws InterruptedException, IOException{
		...
		String csvTestDataFilePath ="C:\\SeleniumJar\\ShoppingCartTestData.csv";
		String resultsToCSV ="C:\\SeleniumJar\\ShoppingCartTestDataRESULTS.csv";
	...
	//    Log.info("customerState: " + customerState);
	    ...
	    driver.findElement(By.name("txtshipPhone")).sendKeys("2021114455");
	      ...
	      FileUtils.copyFile(screenshot, new File("C:\\SeleniumJar\\screenshot\\" + customerName + "screenshot.jpg"));
